...
bcftools view -s $SAMPLE $VCF | bcftools view -i 'GT="het"' -O z -o $WDIR/split_by_sample/$IMPACT.het.$SAMPLE.snpEff.vcf.gz
bcftools view -s $SAMPLE $VCF | bcftools view -i 'GT="hom"' -O z -o $WDIR/split_by_sample/$IMPACT.hom.$SAMPLE.snpEff.vcf.gz
