...
all background information on collected samples can be found [here](https://github.com/osipovarev/Leatherback_popgen/blob/main/dc_222_samples_info.tsv)


## 1. Population structure analysis

Population structure analysis included PCA analysis of whole-genome reseq samples (n=222),

DAPC analysis of Rapture (RAD Capture) reseq samples (n=637),
...
***
## 2. [Heterozygosity analysis](https://github.com/osipovarev/Leatherback_popgen/blob/main/Heterozygosity_222/README.md)
...
***
## 4. Genetic load analysis

Genetic load analysis relied on the variant fitness effect annotation with two tools: snpEff and ANNOVAR;
